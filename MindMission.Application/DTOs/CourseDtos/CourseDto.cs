...
namespace MindMission.Application.DTOs.CourseDtos
{
    public class CourseDto : IDtoWithId<int>
    {
        ...
        public ICollection<LearningItemDto> LearningItems { get; set; } = new List<LearningItemDto>();
        public ICollection<EnrollmentItemDto>? EnrollmentItems { get; set; } = new List<EnrollmentItemDto>();
        public ICollection<CourseRequirementDto>? CourseRequirements { get; set; }
