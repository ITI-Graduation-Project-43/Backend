...
namespace MindMission.Application.Mapping
{
    public class MessageMappingService : IMappingService<Messages, MessageDto>
    {
        ...
        {
            var MessageDTO =new MessageDto { Id=entity.Id,Name=entity.Name,Email=entity.Email,Message=entity.Message,IsReplied=entity.IsReplied,CreatedAt=entity.CreatedAt};
            return MessageDTO;
        }
    }
}
